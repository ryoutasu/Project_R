...
function mt:set_collision(is_collision_effect, is_land_effect, is_air_effect)
    GameAPI.set_point_collision(self._base, is_collision_effect, is_land_effect, is_air_effect)
end
